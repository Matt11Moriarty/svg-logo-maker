...
class Circle extends Shape {
  ...
  render () {
    ...
    <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="Arial" font-size="20" fill="${this.textColor}">${this.text}</text>
  </svg>
    `
    }
}
...
generateNewShape = (answersData) => {
  ...
  switch (answersData.shape.name) {
    case 'Circle':
      newShape = new Circle(answersData.shape.key, answersData.color, answersData.text, answersData.textColor, '150', '150', '80')
      break;
    case 'Triangle':
