...
class Circle extends Shape {
  ...
  render () {
    ...
    <${this.key} cx="${this.center_x}" cy="${this.center_y}" r="${this.radius}" fill="${this.color}" />
    <text x="150" y="100" font-size="20" text-anchor="middle" alignment-baseline="middle" fill="${this.textColor}">${this.text}</text>
  </svg>
    `
    }
}
...
class Triangle extends Shape {
  ...
  render () {
    ...
    <text x="100" y="125" font-size="20" text-anchor="middle" alignment-baseline="middle" fill="${this.textColor}">${this.text}</text>
  </svg>
    `
    }
}
...
class Square extends Shape {
  ...
  render () {
    ...
    <text x="100" y="100" font-size="20" text-anchor="middle" alignment-baseline="middle" fill="${this.textColor}">${this.text}</text>
  </svg>
    `
    }
}
